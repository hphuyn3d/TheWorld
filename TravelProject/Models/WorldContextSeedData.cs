...
namespace TravelProject.Models
{
    public class WorldContextSeedData
    {
        ...
        public WorldContextSeedData(WorldContext context) //uses world context object to add new seed data
        {
            _context = context;
        }
        ...
        public async Task EnsureSeedData()
        {
            ...
            new Stop() { Order = 55, Latitude =  33.748995, Longitude =  -84.387982, Name = "Atlanta, Georgia", Arrival = DateTime.Parse("Jun 17, 2015") },
                ...
                await _context.SaveChangesAsync(); // Pushes data to databases
